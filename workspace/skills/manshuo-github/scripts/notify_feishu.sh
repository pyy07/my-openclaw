...
CHANNEL="${MANSHUO_GITHUB_CHANNEL:-feishu}"
TARGET="${MANSHUO_GITHUB_FEISHU_TARGET:-user:ou_27eafc99a5b351d7df9ca5709e74ea41}"
...
Environment:
  MANSHUO_GITHUB_CHANNEL=feishu
  MANSHUO_GITHUB_FEISHU_TARGET=user:ou_xxx
USAGE
}
